OC.L10N.register(
    ...
    "Your approval was requested on {file}" : "Zahtevana je odobritev za {file}",
    "Your approval was requested on {file} by {who}" : "[who] je zahteval odobritev za {file}",
    ...
    "Error getting OAuth access token" : "Napaka pri pridobivanju OAuth žetona za dostop",
    ...
    "%2$s requested your approval for %1$s" : "%2$s je zahteval odobritev za %1$s",
    "{user} requested your approval for {node}" : "{user} je zahteval odobritev za {node}",
    ...
    "Approve/reject files based on workflows defined by admins." : "Potrjevanje/zavračanje datoek glede na postopke, ki jih določijo skrbniki.",
