OC.L10N.register(
    ...
    "Your approval was requested on {file}" : "Zahtevana je potrditev za {file}",
    "Your approval was requested on {file} by {who}" : "[who] zahteva potrditev za datoteko {file}",
    ...
    "Your approval was requested" : "Zahtevana je odboritev",
    "%2$s requested your approval for %1$s" : "%2$s je zahteval potrditev za %1$s",
    "{user} requested your approval for {node}" : "{user} je zahteval potrditev za {node}",
    "Rule does not exist" : "Pravilo ne obstaja",
    "This element is not shared with any user who is authorized to approve it" : "Ta predmet ni v souporabi z nobenim uporabnikom, ki ima dovoljenje za potrditev",
    ...
    "Who can request approval" : "Kdo lahko zahteva potrditev",
    "Who can approve" : "Kdo lahko potrdi",
    "Tag to act on" : "Oznake za odziv",
    "Tag set on approval" : "Oznaka je označena na odobritev",
    "Tag set on rejection" : "Oznaka je označena na zavrnitev",
