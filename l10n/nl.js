OC.L10N.register(
    ...
    "If you want to use DocuSign, create an application in your DocuSign 'My Apps & Keys' developer account settings and put the client ID (integration key) and secret below." : "Als je DocuSign wilt gebruiken, maak je een toepassing aan in de instellingen van je DocuSign 'Mijn apps & sleutels'-ontwikkelaarsaccount en plaats je de client-ID (integratiesleutel) en het Secret hieronder.",
