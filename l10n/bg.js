OC.L10N.register(
    ...
    "Failed to save DocuSign admin options" : "Неуспешно  запазване на Опциите за администратор на DocuSign",
    "Failed to save DocuSign OAuth state" : "Неуспешно  запазване на състоянието на OAuth в DocuSign",
