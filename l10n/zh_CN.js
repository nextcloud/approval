OC.L10N.register(
    ...
    "Your approval was requested for file %1$s" : "你被请求批准文件 %1$s",
    "Your approval was requested for directory %1$s" : "你被请求批准目录 %1$s",
    ...
    "If you want to use DocuSign, create an application in your DocuSign 'My Apps & Keys' developer account settings and put the client ID (integration key) and secret below." : "如果你想使用DocuSign，在你的DocuSign“我的应用程序和密钥”开发帐户设置中创建一个应用程序，并将客户端ID(集成密钥)和 secret 放在下面。",
    ...
    "Client ID of your application" : "你的应用程序的客户端 ID",
    ...
    "Failed to save DocuSign admin options" : "未能保存 DocuSign 管理选项",
    "Failed to save DocuSign OAuth state" : "未能保存 DocuSign OAuth 状态",
    ...
    "approved {name}" : "已批准 {name} ",
    "Failed to approve {name}" : "未能批准 {name}",
    "Rejected {name}" : "已拒绝 {name}",
    "Failed to reject {name}" : "未能拒绝 {name}",
    "Approval requested for {name}" : "请求批准 {name}",
    "Warning" : "警告",
    "Failed to request approval for {name}" : "请求批准 {name} 失败",
    "Approval requested for {name}!" : "请批准 {name}！",
    ...
    "{name} signature requested via LibreSign!" : "已通过 LibreSign 请求 {name} 的签名",
    ...
    "{name} approved!" : "{name} 已被批准！",
    "{name} rejected!" : "{name} 已被拒绝！"
},
"nplurals=1; plural=0;");
