OC.L10N.register(
    ...
    "The file/folder you tried to approve has an outdated content, please reload and review it again" : "Soubor/Složka kterou se snažíte odsouhlasit zobrazuje zastaralý obsah, načtěte a zkontrolujte ji znovu",
    "The file/folder you tried to reject has an outdated content, please reload and review it again" : "Soubor/Složka kterou se snažíte zamítnout zobrazuje zastaralý obsah, načtěte a zkontrolujte ji znovu",
    ...
    "Remove file approval when file is modified" : "Pokud bude změněn, odebrat schválení souboru",
    ...
    "Your approval was requested." : "Bylo požádáno o vaše schválení.",
    "Approved by {user}" : "Schválil/a {user}",
    "Approved by you" : "Schváleno vámi",
    "Rejected by {user}" : "Odmítl/a {user}",
    ...
    "Reason for approval: {message}" : "Důvod schválení: {message}",
    "Reason for rejection: {message}" : "Důvod zamítnutí: {message}",
    ...
    "Pending approval, click to approve/reject" : "Čeká na schválení – schválíte/odmítnete kliknutím",
    ...
    "Approve or Reject" : "Schválit nebo zamítnout",
