OC.L10N.register(
    ...
    "A directory was rejected" : "Složka byla odmítnuta",
    ...
    "Your approval was requested for file %1$s" : "Bylo požádáno o vaše schválení pro soubor %1$s",
    "Your approval was requested for directory %1$s" : "Bylo požádáno o vaše schválení pro složku %1$s",
    ...
    "Approve/reject files based on workflows defined by admins." : "Schvalujte/odmítejte soubory na základě postupů, definovaných správci.",
    ...
    "Failed to create approval workflow" : "Nepodařil ose vytvořit schvalovací postup",
    ...
    "approved {name}" : "schváleno {name}",
    "Failed to approve {name}" : "Nepodařilo se schválit {name}",
    "Rejected {name}" : "Zamítl(a) {name}",
    ...
    "{name} approved!" : "{name} schváleno!",
    "{name} rejected!" : "{name} zamítnuto!"
},
