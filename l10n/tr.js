OC.L10N.register(
    ...
    "Approval has already been request with this rule for this file" : "Bu dosya için zaten bu kuralla onay istendi",
    ...
    "If you want to use DocuSign, create an application in your DocuSign \"My Apps & Keys\" developer account settings and put the client ID (integration key) and secret below." : "DocuSign kullanmak istiyorsanız, DocuSign geliştirici hesabı ayarlarınızda \"Uygulamalarım ve Anahtarlarım\" bölümünden bir uygulama oluşturun ve istemci kodunu (bütünleştirme anahtarı) ve gizli anahtarını aşağıya yazın.",
    ...
    "Client ID (aka integration key)" : "İstemci kodu (bütünleştirme anahtarı)",
    "Client ID of your application" : "Uygulamanızın istemci kodu",
