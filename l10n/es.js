OC.L10N.register(
    ...
    "The file/folder you tried to approve has an outdated content, please reload and review it again" : "El archivo o carpeta que intentaste aprobar tiene un contenido desactualizado, vuelve a cargarlo y revísalo nuevamente",
    "The file/folder you tried to reject has an outdated content, please reload and review it again" : "El archivo o carpeta que intentaste rechazar tiene un contenido desactualizado, vuelve a cargarlo y revísalo nuevamente",
    ...
    "You do not have access to this file" : "No tienes acceso a este archivo",
    "You cannot share this file" : "No puedes compartir este archivo",
    "Rule does not exist" : "La regla no existe",
    "Approval has already been granted with this rule for this file" : "Ya se ha concedido la aprobación con esta regla para este archivo",
    ...
    "Reason for approval: {message}" : "Motivo para aprobación: {message}",
    "Reason for rejection: {message}" : "Motivo para rechazo: {message}",
    ...
    "Pending approval, click to approve/reject" : "Pendiente de aprobación, haga clic para aprobar/rechazar",
