OC.L10N.register(
    ...
    "The file/folder you tried to approve has an outdated content, please reload and review it again" : "Файл/папка, которую вы пытались утвердить, имеет устаревшее содержимое. Обновите и просмотрите её ещё раз.",
    "The file/folder you tried to reject has an outdated content, please reload and review it again" : "Файл/папка, которую вы пытались отклонить, имеет устаревшее содержимое. Перезагрузите и просмотрите её ещё раз.",
    ...
    "You do not have access to this file" : "У вас нет доступа к этому файлу",
    "You cannot share this file" : "Вы не можете поделиться этим файлом",
    "Rule does not exist" : "Правило не существует",
    "Approval has already been granted with this rule for this file" : "Это правило уже одобрено для этого файла",
    ...
    "Approve/reject files based on workflows defined by admins.\n\n**Warning**: The DocuSign integration is no longer part of this app\nand can be installed with [this app](https://apps.nextcloud.com/apps/integration_docusign)." : "Утвердить/отклонить файлы в соответствии с рабочими процессами, определенными администрацией.\n\n**Предупреждение**: интеграция DocuSign больше не является частью этого приложения и может быть установлена [вот этим приложением](https://apps.nextcloud.com/apps/integration_docusign).",
    "Cancel" : "Отмена",
    ...
    "Create new restricted tag" : "Создать новый ограниченный тэг",
    ...
    "Remove file approval when file is modified" : "Убрать запрос согласования с файла если файл был изменен",
    ...
    "you" : "вы",
    "The related approval workflow is: {ruleDescription}" : "Связанный с этим рабочий процесс согласования: {ruleDescription}",
    "This user requested your approval" : "Этот пользователь запросил ваше согласие",
    "Your approval was requested." : "Было запрошено ваше согласование.",
    "Approved by {user}" : "Согласовано {user}",
    "Approved by you" : "Согласовано вами",
    "Rejected by {user}" : "Отклонено {user}",
    "Rejected by you" : "Отклонено вами",
    "Approval requested by {user}" : "{user} запросил согласование",
    "Approval requested by you" : "Вы запросили согласование",
    "Reason for approval: {message}" : "Причина одобрения: {message}",
    "Reason for rejection: {message}" : "Причина отказа: {message}",
    "Reason (optional)" : "Причина (опционально)",
    "Request approval" : "Запросить согласование",
    "There is no approval workflow allowing you to request approval." : "Не существует рабочего процесса утверждения, позволяющего вам запросить утверждение.",
    "Approval information" : "Информация о согласовании",
    "Who?" : "Кто?",
    ...
    "Pending approval, click to approve/reject" : "Ожидающие согласования, нажмите, чтобы одобрить/отклонить",
    ...
    "Waiting for your approval" : "Ожидает вашего одобрения",
