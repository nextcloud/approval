OC.L10N.register(
    ...
    "There is no approval workflow allowing you to request approval." : "Não há fluxo de trabalho de aprovação que permita solicitar aprovação.",
    "Approved" : "Aprovado",
    "Approved by" : "Aprovado por ",
    "Rejected" : "Rejeitado",
    "Rejected by" : "Rejeitado por ",
    "Approval requested by" : "Aprovação solicitada por ",
    "Approval requested" : "Solicitar aprovação",
    "you" : "você",
    "The related approval workflow is: {ruleDescription}" : "O fluxo de trabalho de aprovação relacionado é: {ruleDescription}",
    ...
    "Select approval workflow" : "Selecione o fluxo de trabalho de aprovação",
    ...
    "Failed to get approval pending files" : "Falha ao obter arquivos pendentes de aprovação ",
    "by {name} at {date}" : "por {name} em {date}",
    "at {date}" : "em {date}",
    "Waiting for authorized users to approve this file" : "Aguardando usuários autorizados aprovarem este arquivo",
    "Pending approval, you are authorized to approve" : "Aguardando aprovação, você está autorizado a aprovar",
    ...
    "Waiting for your approval" : "guardando sua aprovação",
