OC.L10N.register(
    ...
    "Approval workflows" : "تدفُّقات إجراءات workflows الموافقة",
    ...
    "You can chain approval workflows by using a pending tag as approved/rejected tag in another workflow." : "يمكن وضع مجموعة موافقات في شكل سلسلة chain approval؛ و ذلك بوضع سمة التعليق pending tag على الملف عقب الموافقة عليه أو رفضه ليتم إرساله إلى التدفق الإجرائي WF التالي.",
    ...
    "Create workflow" : "أنشِيءْ تدفُّقاً إجرائيّاً WF",
    ...
    "you" : "أنت",
    "The related approval workflow is: {ruleDescription}" : "التدفق الإجرائي WF ذو الصلة هو: {ruleDescription}",
