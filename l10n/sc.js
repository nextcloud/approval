OC.L10N.register(
    ...
    "Pending approvals" : "Aprovatziones in suspesu",
    ...
    "Tag set on approval" : "Eticheta cunfigurada in aprovatzione",
    "Tag set on rejection" : "Eticheta cunfigurada in refudu",
    ...
    "Approved" : "Aprovadu",
    "Rejected" : "Refudadu",
    "Approval requested" : "Aprovatzione recherta",
    "you" : "tue",
    "Your approval was requested." : "Ant rechertu s'aprovatzione tua.",
    ...
    "More files to approve" : "Àteros archìvios de aprovare",
    "No files to approve!" : "Perunu archìviu de aprovare",
    "Failed to get approval pending files" : "No at fatu a otènnere is archìvios cun aprovatzione in suspesu",
    "by {name} at {date}" : "dae {name} su {date}",
    "at {date}" : "su {date}",
