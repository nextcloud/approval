OC.L10N.register(
    ...
    "Approve/reject files based on workflows defined by admins." : "Схвалення/відхилення файлів на основі робочих процесів, визначених адміністраторами.",
    "Each workflow defines who (which users, groups or circles) can approve files for a given pending tag and which approved/rejected tag should then be assigned." : "Кожен робочий процес визначає, хто (які користувачі, групи чи кола) може затверджувати файли для даного тегу, що очікує на розгляд, і який тег схваленого/відхиленого потім слід призначити.",
    ...
    "To be considered approved, a file/directory having multiple pending tags assigned must be approved by all the workflows involved." : "Щоб вважатися схваленим, файл/каталог із кількома призначеними тегами, що очікують на розгляд, має бути схвалено всіма задіяними робочими процесами.",
    ...
    "All tags must be different in a workflow. A pending tag can only be used in one workflow." : "Усі теги мають бути різними в робочому процесі. Тег, що очікує на розгляд, можна використовувати лише в одному робочому процесі.",
    "Delete workflow" : "Вилучити робочий процес",
    "No workflow yet" : "Поки немає робочого процесу",
    "New workflow" : "Новий робочий процес",
    "Create new hidden tag" : "Створіть новий прихований тег",
    "New tag name" : "Нова назва тегу",
    "Create" : "Створити",
    "Cancel" : "Скасувати",
    "All fields are required" : "Всі поля обов'язкові для заповнення",
    "All tags must be different" : "Усі теги мають бути різними",
    "Pending tag is already used in another workflow" : "Тег очікування вже використовується в іншому робочому процесі",
    ...
    "Approval workflow deleted" : "Робочий процес затвердження видалено",
    "Failed to delete approval workflow" : "Не вдалося вилучити процес затвердження",
    "Tag \"{name}\" created" : "Тег \"{name}\" створено",
    "Failed to create tag \"{name}\"" : "Не вдалося створити тег \"{name}\"",
    "Approve" : "Схвалити",
    "Reject" : "Скасувати",
    "Select pending tag" : "Виберіть незавершений тег",
    "Who can request approval?" : "Хто може запитувати схвалення?",
    "Who can approve?" : "Хто може схвалити?",
    "Select approved tag" : "Виберіть затверджений тег",
    "Select rejected tag" : "Виберіть відхилений тег",
    "Who can request approval" : "Хто може запитувати схвалення",
    "Who can approve" : "Хто може схвалити",
    "Tag to act on" : "Тег для дії",
    "Tag set on approval" : "Тег встановлено на затвердження",
    "Tag set on rejection" : "Тег встановлено на відхилення",
    ...
    "Approval requested by" : "Запит на схвалення",
