OC.L10N.register(
    "approval",
    {
    "You approved {file}" : "Vostede aprobou {file}",
    "{user} approved {file}" : "{user} aprovou {file}",
    "You rejected {file}" : "Vostede rexeitou {file}",
    ...
    "You requested approval on {file}" : "Vostede solicitou a aprobación de {file}",
    ...
    "Approve/reject files based on workflows defined by admins." : "Aprobar/rexeitar ficheiros en función dos fluxos de traballo definidos polos administradores.",
    ...
    "Create" : "Crear",
    "Cancel" : "Cancelar",
    "All fields are required" : "Son obrigatorios todos os campos",
    ...
    "Make sure you set this \"Redirect URI\":" : "Asegúrese de estabelecer este «URI de redirección»:",
    ...
    "at {date}" : "o {date}",
    "You approved {name}" : "Vostede aprobou {name}",
    "Failed to approve {name}" : "Produciuse un fallo ao aprobar {name}",
    "You rejected {name}" : "Vostede rexeitou {name}",
    ...
    "The user who requested this approval was not found, remember to send or share the signed document yourself" : "Non se atopou o usuario que solicitou esta aprobación, lembre enviar ou compartir o documento asinado vostede mesmo",
    ...
    "Pending approval, you are authorized to approve." : "Pendente de aprobación, vostede está autorizado para aprobar.",
