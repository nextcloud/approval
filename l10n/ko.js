OC.L10N.register(
    ...
    "{user} rejected {file}" : "{사용자}가 {파일}을 거부했습니다",
    "Your approval was requested on {file}" : "당신의 승인은 {파일}에 요청됐었습니다",
    "Your approval was requested on {file} by {who}" : "당신의 승인 {누군가}에 의해 {파일}에 요청됐었습니다",
    "You requested approval on {file}" : "당신은 {파일} 승인 요청했습니다",
    "A guest user" : "손님 사용자",
    "Approval" : "승인",
    ...
    "A file was approved" : "파일이 승인 됐었습니다",
    "A file was rejected" : "파일이 거부 됐었습니다",
    "A directory was approved" : "디렉토리가 승인 됐었습니다",
    "A directory was rejected" : "디렉토리가 거부 됐었습니다",
    ...
    "Your approval was requested" : "당신의 승인은 요청됐었습니다",
    ...
    "Approve/reject files based on workflows defined by admins." : "관리자가 정의한 워크플로에 기반하여 파일을 승인/거부합니다",
    ...
    "Approve" : "승인",
    "Reject" : "거부",
    "Select pending tag" : "보류 태그를 선택하십시오",
    "Who can request approval?" : "누가 승인을 요청할 수 있습니까?",
    "Who can approve?" : "누가 승인할 수 있습니까?",
    "Select approved tag" : "승인된 태그를 선택하십시오",
    "Select rejected tag" : "거부된 태그를 선택하십시오",
    "Who can request approval" : "누가 승인을 요청할 수 있습니까",
    "Who can approve" : "누가 승인할 수 있습니까?",
    ...
    "Rejected" : "거부됐습니다",
    "Rejected by" : "의해 거부됐습니다",
    "Approval requested by" : "의해 승인이 요청됐습니다",
    "Approval requested" : "승인이 요청됐습니다",
    "you" : "나",
    "Request approval" : "요청 승인",
    "Sign with DocuSign" : "DocuSign에 서명하십시오",
    "Sign with LibreSign" : "LibreSign에 서명하십시오",
    "Your approval was requested by {name}." : "당신의 승인이 {이름}에 의해 요청됐었습니다",
    "The related approval workflow is:" : "관련된 승인 워크플로는: ",
    "Your approval was requested." : "당신의 승인은 요청됐었습니다",
    "Request a signature via DocuSign" : "DocuSign을 통해 서명을 요청하십시오",
    "Users or email addresses" : "사용자들 혹은 이메일 주소",
    "Nextcloud users or email addresses" : "Nextcloud 사용자들 혹은 이메일 주소",
    "Recipients will receive an email from DocuSign with a link to sign the document. You will be informed by email when the document has been signed by all recipients." : "수신자는 DocuSign으로부터 문서로 연결되는 링크가 있는 이메일을 수신할 것입니다. 당신은 모든 수신자가 문서에 서명할 경우 이메일을 통해 정보를 전달 받을 것입니다",
    "Request signature" : "서명을 수신 받습니다 ",
    "Recipients will receive an email from DocuSign to sign the document" : "수신자는 문서에 서명하기 위해 DocuSign으로부터 이메일을 수신할 것입니다  ",
    ...
    "Select approval workflow" : "승인 워크플로를 선택하십시오",
    "File will be automatically shared with everybody allowed to approve." : "파일은 승인이 허락된 모든 사람에게 자동적으로 공유될 것입니다",
    "Can be approved by" : "의해 승인될 수 있습니다",
    "More files to approve" : "승인해야 할 더 많은 파일",
    "No files to approve!" : "승인할 파일이 없습니다!",
    "Failed to get approval pending files" : "보류 중인 파일의 승인이 거절됐습니다",
    "by {name} at {date}" : "{날짜}에 {이름}에 의해 ",
    "You approved {name}" : "당신이 {이름}을 승인했습니다",
    "Failed to approve {name}" : "{이름}을 승인하는데 실패했습니다",
    "You rejected {name}" : "당신이 {이름}을 거부했습니다",
    "Failed to reject {name}" : "{이름}을 거부하는데 실패했습니다",
    "Approval requested for {name}" : "{이름}을 위한 승인이 요청됐습니다",
    "Warning" : "경고",
    ...
    "The user who requested this approval was not found, remember to send or share the signed document yourself" : "이 승인을 요청한 사용자를 찾을 수 없습니다, 서명된 문서를 자신에게 보내거나 공유하는 것을 기억하십시오 ",
