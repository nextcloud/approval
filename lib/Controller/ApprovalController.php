...
class ApprovalController extends OCSController {
	...
	public function approve(int $fileId, string $etag): DataResponse {
		try {
			...
			return new DataResponse(
				['error' => $this->l10n->t('The file/folder you tried to approve has an outdated content, please reload and review it again')],
	...
	public function reject(int $fileId, string $etag): DataResponse {
		try {
			...
			return new DataResponse(
				['error' => $this->l10n->t('The file/folder you tried to reject has an outdated content, please reload and review it again')],
				Http::STATUS_BAD_REQUEST
			);
		}
	}
