		...
		<div class="fields">
			...
			<div class="tag">
				...
				<NcSelectTags
					...
					:limit="null"
					@update:modelValue="update('tagPending', $event)" />
			</div>
			<div class="users">
				<span class="field-label">
